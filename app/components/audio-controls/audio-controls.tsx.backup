...
export function AudioControls() {
    ...
    return (
      <div className="flex items-end gap-0.5 h-4">
        {[...Array(8)].map((_, i) => (
          <div
            key={i}
            className="w-1 rounded bg-blue-400 transition-all duration-300"
            style={{
              height: isPlaying
  ...
  return (
    <div className="w-full bg-white flex flex-col items-center px-2 py-2 shadow-lg sticky bottom-0 mb-8 z-40">
      ...
      <div className="flex items-center w-full max-w-xl justify-between gap-4">
        ...
        <button
          ...
          className="bg-black text-white rounded-full w-12 h-12 flex items-center justify-center text-2xl hover:bg-gray-800 transition"
        ...
        <button
          ...
          className="bg-black text-white rounded-full w-10 h-10 flex items-center justify-center text-lg hover:bg-gray-800 transition"
          aria-label="Favorite"
        >

...
export default function WalletBalance({
  ...
  return <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl 
            absolute top-4 
            left-4 right-4
            ...
            <div className="p-2 md:p-4">
                ...
                <div className="hidden md:block space-y-2">
                    ...
                    <div className="w-full bg-gray-100 rounded-full h-3">
                        <div className="bg-gradient-to-r from-black to-gray-600 h-3 rounded-full transition-all duration-500 ease-in-out" style={{
            width: `${Math.min(progressPercentage, 100)}%`
          }}></div>
                    </div>
                    <a href="https://shinedark.dev" target="_blank" rel="noopener noreferrer" className="block mt-2 text-sm font-medium text-black hover:text-black-700 transition-colors">
                ...
                <div className="md:hidden">
                    <div className="flex flex-col items-center text-center">
                        ...
                        <a href="https://shinedark.dev" target="_blank" rel="noopener noreferrer" className="mt-1 text-xs font-medium text-black hover:text-black-700 transition-colors">
                            Donate to continue the vision
                        </a>
                    </div>
                </div>

  ...
  const handleNotifyMe = async (productName: string, price: string) => {
    ...
    try {
      const response = await fetch('/api/notify-interest', {
        ...
        body: JSON.stringify({ email, product: productName, price })
      });
  ...
  return (
      <div className="w-full">
        ...
        <div className="max-w-6xl mx-auto px-8 py-20">
          ...
          {message && (
            <div className="mb-8 p-4 bg-gray-200 border-2 border-gray-800 rounded-lg text-center text-gray-900 font-semibold">
              {message}
            </div>
          )}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-6 border-2 border-gray-800 shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="w-full h-64 mb-4 relative overflow-hidden rounded-lg grayscale hover:grayscale-0 transition-all duration-300">
                <img 
                  src="/images/front vinyl.png" 
                  alt="El Archivo Vinyl" 
              ...
              <input
                ...
                className="w-full px-4 py-2 mb-3 border-2 border-gray-800 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-700"
              />
              <button
                onClick={() => handleNotifyMe('El Archivo Vinyl', '$33 + shipping')}
                disabled={isSubmitting}
                className="w-full bg-gray-900 hover:bg-gray-700 text-white px-6 py-3 rounded-lg transition-colors duration-300 font-semibold disabled:opacity-50"
              >
            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-6 border-2 border-gray-800 shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              />
              <button
                onClick={() => handleNotifyMe('Para Ti Box', '$11 + shipping')}
                disabled={isSubmitting}
                className="w-full bg-gray-900 hover:bg-gray-700 text-white px-6 py-3 rounded-lg transition-colors duration-300 font-semibold disabled:opacity-50"
              >
            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-6 border-2 border-gray-800 shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="w-full h-64 mb-4 relative overflow-hidden rounded-lg grayscale hover:grayscale-0 transition-all duration-300">
                <img 
                  src="/images/vinyl back.png" 
                  alt="El Archivo MP3 Collection" 
                  className="w-full h-full object-cover opacity-90"
                />
              </div>
              ...
              />
              <button
                onClick={() => handleNotifyMe('El Archivo MP3 Collection', '$33')}
                disabled={isSubmitting}
                className="w-full bg-gray-900 hover:bg-gray-700 text-white px-6 py-3 rounded-lg transition-colors duration-300 font-semibold disabled:opacity-50"
              >

...
const projects: Project[] = [{
  ...
  techStack: ['React', 'GraphQL & Apollo Client', 'Polygon', 'Styled Components', 'Pinata & IPFS', 'Remix', 'Ethereum Sepolia', 'Solidity', 'Hardhat'],
...
const ProjectCard: React.FC<{
  ...
  return <div className="bg-white rounded-xl p-6 mb-8 mt-20 mb-20 border border-gray-200 shadow-lg">
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-wrap gap-2">
          {project.techStack.map((tech, index) => <span key={index} className="px-3 py-1 bg-gray-100 rounded-full text-sm text-gray-700">
              {tech}
            </span>)}
        </div>
      </div>

      <a href={project.link} target="_blank" rel="noopener noreferrer" className="inline-block bg-gray-900 hover:bg-gray-800 text-white px-6 py-2 rounded-full transition-colors duration-300">
        View Project
      </a>
    </div>;
};
